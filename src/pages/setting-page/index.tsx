		...
		<div style={{ padding: "20px 0" }}>
			...
			<Button
				onClick={() => {
					...
					let blob = new Blob([JSON.stringify(newConfig, null, 2)], {
					...
					tempLink.setAttribute(
						"download",
						decodeURI(config.bucket + "_" + new Date().toLocaleDateString())
					)
			...
			<Upload
				...
				customRequest={(e) => {
					...
					reader.onload = () => {
						const { config: newConfig, management: newManagement } = JSON.parse(
